...
export const pt: Dictionary = {
  ...
  'footer.text':
    'Site da unidade, mantido pela própria unidade. Não é um site oficial de A Igreja de Jesus Cristo dos Santos dos Últimos Dias.',
  ...
  'validation.unit.invalidTimezone': 'Informe um fuso horário válido, por exemplo America/Sao_Paulo.',
  ...
  'callings.confirmRemovePerson':
    'Remover esta pessoa definitivamente, incluindo o histórico de chamados dela? Isso não pode ser desfeito.',

  'people.hasCurrentCalling':
    'Esta pessoa ainda tem um chamado atual. Desobrigue-a primeiro e depois remova.',
  'people.removed': 'Pessoa removida.',
  ...
  'users.photoWarning':
    'Ativar isto permite que essa pessoa envie sua própria foto de perfil. Este site não guarda datas de nascimento e não consegue saber quem é menor de idade: nunca habilite isto na conta de um menor. Essa decisão é só do bispado.',
  'users.photoUploadEnable': 'Permitir foto de perfil',
  'users.photoUploadDisable': 'Remover permissão de foto de perfil',
  ...
  'activities.audience': 'Visibilidade',
  ...
  'activities.cover': 'Imagem de capa',
  'activities.removeCover': 'Remover a imagem de capa atual',
  'activities.reselectCover': 'A imagem escolhida não foi mantida: selecione-a novamente.',
  'activities.currentCover': 'Imagem de capa atual',
  ...
  'announcements.intro': 'Avisos para a unidade e suas organizações.',
  'announcements.empty': 'Nenhum aviso para mostrar.',
  'announcements.new': 'Novo aviso',
  'announcements.edit': 'Editar aviso',
  'announcements.delete': 'Excluir',
  'announcements.confirmDelete': 'Excluir este aviso permanentemente?',
  'announcements.titleLabel': 'Título',
  'announcements.saveChanges': 'Salvar alterações',
  'announcements.from': 'De',
  'announcements.until': 'Até',
  'announcements.expired': 'Expirado',
  'announcements.organization': 'Organização',
  'announcements.unitWide': 'Toda a unidade',
  'announcements.audience': 'Visibilidade',
  ...
  'profile.photoAlt': 'Sua foto de perfil',
  'profile.upload': 'Enviar foto',
  'profile.uploaded': 'Foto atualizada.',
  'profile.delete': 'Remover foto',
  'profile.confirmDelete': 'Remover sua foto de perfil?',
  'profile.notAllowed':
  ...
  'forbidden.backHome': 'Voltar para o início',
